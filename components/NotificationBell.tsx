...
const NotificationBell: React.FC<NotificationBellProps> = ({ alerts, variant = 'dark' }) => {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {isOpen && (
        <div className={`absolute top-full ${variant === 'dark' ? 'left-0 mt-2' : 'left-0 mt-2'} w-80 bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 overflow-hidden animate-slide-up transform origin-top-left`}>
