...
const LiveChronometer = memo(({ 
  ...
  return (
    <div className="bg-slate-900 text-white rounded-[2rem] md:rounded-[3.5rem] shadow-2xl relative overflow-hidden h-full border border-slate-800 group transition-all duration-500 w-full animate-fade-in flex flex-col" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
